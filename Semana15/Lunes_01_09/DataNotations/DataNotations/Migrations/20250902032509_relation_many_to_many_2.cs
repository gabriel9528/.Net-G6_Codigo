...
{
    /// <inheritdoc />
    public partial class relation_many_to_many_2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusinessPerson", x => new { x.BusinessesId, x.PeopleId });
                    table.ForeignKey(
                        name: "FK_BusinessPerson_Businesss_BusinessesId",
